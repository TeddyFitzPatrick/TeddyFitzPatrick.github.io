...
function About() {
    return (
        <>
            <div className="h-fit w-[95%] md:w-3/4 xl:w-1/2 pl-4 mt-[calc(10vh+3rem)] text-3xl bg-white text-slate-800 p-8 rounded-2xl shadow-2xl text-center">
            ...
            <div className="h-fit w-[95%] md:w-3/4 xl:w-1/2 pl-4 mt-4 text-3xl bg-slate-800 p-8 rounded-2xl shadow-2xl text-center">
            ...
            <div className="h-fit w-[95%] md:w-3/4 xl:w-1/2 pl-4 mt-4 text-3xl bg-white text-slate-800 p-8 rounded-2xl shadow-2xl text-center">
            ...
            <div className="w-[95%] sm:w-fit h-fit mt-4 space-y-4 text-3xl bg-slate-800 text-white p-8 rounded-2xl shadow-2xl text-center mb-4">
                <h1>Links:</h1>
