    ...
    return (
        <>
            <div className="absolute flex flex-col w-1/2 h-1/2 top-1/4 left-1/4 items-center justify-evenly">
                ...
                {/* Chess */}
                <TextAnim text="{ Rewriting in TypeScript... }" cooldown={20}
                    className="z-10 text-xl md:text-3xl 
                    hover:scale-105 font-bold bg-slate-800 text-cyan-700 italic border-cyan-500 border-8 p-2 rounded-xl shadow-2xl"/>
            </div>
            {/* Particle Simulation */}
